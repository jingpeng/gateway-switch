...
public class CRCTool {
    private static int[] crc_table = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7, 0x8108, 0x9129, 0xa14a,
    ...
    public static int calcCrc16_2(int[] ptr, int offset ,int length) {
    ...
    public static int calcCrc16(int[] data, int offset, int len) {
        ...
        return calcCrc16_2(data,offset,len);
    }
